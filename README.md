...
Текущая опубликованная версия репозитория — `1.4.0`. Версии плагинов развиваются независимо. Исторические опубликованные релизы и теги сохраняются неизменяемыми (`immutable`) и не переназначаются на новые коммиты.
